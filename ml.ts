/*
This file contains the code to register and deploy an ml model to the opensearch cluster.
It also creates a neural ingest pipeline to allow for ingesting of documents into a knn index.
*/
import { Client } from '@opensearch-project/opensearch'
import type { ClientOptions } from '@opensearch-project/opensearch'

export async function deploy_ml_model(opts: ClientOptions) {
